...
function apiPage(): string {
	...
	<div class="text-center margin content">
		...
		<a data-umami-event="endpoint-api" href="/api/forsen/id:117691339">${baseUrl}/api/forsen/id:11769133</a>
...
function statusPage(): string {
	...
	async function loadStatus() {
		...
		function updateTimes() {
			...
			const nextTime = getTime(data.lastUpdate + data.nextUpdate, true);
